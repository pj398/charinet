...
pseudo-dyadic structure upon the interactions.
<!-- For data which already exists in a dyadic format (with "from" and "to" columns for each event), the helper function `dyadic_to_multicast` converts this to the multicast format.-->
